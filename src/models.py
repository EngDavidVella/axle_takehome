...
class SystemStateManager:
    ...
    def _init_session_system_state(self):
        ...
        for key, value in self._system_state_attr.items():
    ...
    def _render_sidebar_controls_for_demo(self): 
        # For demo only this would usually be hooked to the car/charger and/or database instead
    ...
    def get_state(self):
        ...
        return {
            ...
            for key in self._system_state_attr
        }
